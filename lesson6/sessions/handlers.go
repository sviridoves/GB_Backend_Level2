...
var confirmFormTmpl = []byte(`
<html>
<body>
<form action="/confirm" method="post">
ConfirmCode: <input type="text" name="code">
...
func (c RedisClient) LoginHandler(w http.ResponseWriter, r *http.Request) {
	...
	confirmCode = rand.Intn(9999)
	log.Printf("Confirm Code: %v", confirmCode)
	_, _ = w.Write(confirmFormTmpl)
}
...
func (c RedisClient) ConfirmHandler(w http.ResponseWriter, r *http.Request) {
	inputCode := r.FormValue(confirmCodeValue)
	code, err := strconv.Atoi(inputCode)
	if err != nil {
